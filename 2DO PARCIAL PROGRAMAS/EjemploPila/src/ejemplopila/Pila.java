...
return top;	}
public Nodo visitarPila(Nodo i){ //recorre la pila y muestra el contenido System.out.println("Inicia metodo recorrer Pila "); System.out.println("Valor de i "+ i.getElemento());
Nodo s= new Nodo(0,null); while(i.getSiguiente()!=null){
s=i.getSiguiente();
System.out.println("Valor visitado "+ s.getElemento()); i=s;
}
return i;
}
public String toString() { //muestra los valores de la pila
if (isEmpty()) { return "La pila esta vacía"; } else
{ String resultado = ""; Nodo aux = top;
while (aux != null) {
resultado += aux.toString(); aux = aux.getSiguiente();
}
return resultado;
}
}
